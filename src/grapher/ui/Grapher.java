...
public class Grapher extends JPanel implements MouseInputListener {
	...
	public Grapher() {
		...
		MouseInputAdapter mia = new MouseInputAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				gauche=false;droite=false;droitedragged=false;gauchedragged=false;milieu=false;
			}
	...
	public void drawFunction(Graphics2D g2, Function f, boolean highlight){
